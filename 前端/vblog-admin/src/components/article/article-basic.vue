	...
	<div>
		<el-table :data="articleList" stripe border v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
		 element-loading-background="rgba(0, 0, 0, 0.8)" style="width: 100%">
			...
			<el-table-column prop="dingCount" label="点赞数">
			</el-table-column>
			<el-table-column prop="caiCount" label="点踩数">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" width="150">
				<template slot-scope="scope">
					<el-button type="text" style="padding: 3px; margin: 0 10px;" @click="lookDetail">查看</el-button>
					<el-button type="danger" style="padding: 3px;">编辑</el-button>
				</template>
